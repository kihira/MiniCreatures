...
public class ModelTRex extends ModelBase {
    ...
    public ModelTRex() {
        ...
        leftLegFoot.addBox(-1.5F, 0F, -2.5F, 3, 1, 4);
        leftLegFoot.setRotationPoint(2.5F, 23F, 0.5F);
        ...
        rightLegLower.addBox(-0.5F, 0F, -1F, 1, 6, 2);
        rightLegLower.setRotationPoint(-2.5F, 18.3F, -2.3F);
        setRotation(rightLegLower, 0.5759587F, 0F, 0F);
        rightLegFoot = new ModelRenderer(this, 0, 0);
        rightLegFoot.addBox(-1.5F, 0F, -2.5F, 3, 1, 4);
        rightLegFoot.setRotationPoint(-2.5F, 23F, 0.5F);
